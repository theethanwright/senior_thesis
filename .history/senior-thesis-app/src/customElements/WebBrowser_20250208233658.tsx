...
export function LiveBrowser({ shape }: { shape: BrowserShape }) {
  ...
  useEffect(() => {
    // Call the function to get the array of selected shape IDs.
    const selectedIds = editor.getSelectedShapeIds();
    // If the shape's id is included in the array then the iframe is active.
    const isSelected = selectedIds.includes(shape.id);
    // When not selected, iframeDisabled becomes true.
