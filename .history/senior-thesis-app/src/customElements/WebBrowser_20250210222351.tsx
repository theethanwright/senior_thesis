...
export function LiveBrowser({ shape, onToggleOverlay }: { shape: BrowserShape }) {
...
export class BrowserShapeUtil extends BaseBoxShapeUtil<BrowserShape> {
  ...
  override onClick(shape: BrowserShape) {
    console.log(`BrowserShape clicked! ID: ${shape.id}, URL: ${shape.props.url}`);
  }
}
